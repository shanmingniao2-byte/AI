...
- 🎨 文生图功能，支持智谱AI CogView-4 与腾讯混元·即梦模型生成高质量图像
- 📱 响应式设计，支持移动设备
- 🔄 一键交换源语言和目标语言
- 📋 一键复制翻译结果
...
3. 在“即梦 API 凭证”区域填写腾讯云提供的 SecretId、SecretKey 以及区域后点击“保存即梦配置”
...
3. 从下拉菜单中选择图像生成引擎（智谱AI CogView-4 或 腾讯混元·即梦）
...
- API：智谱AI GLM模型API、腾讯云混元·即梦 API、Google Gemini API
